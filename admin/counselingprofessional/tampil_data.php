...
<head>
  ...
  <title>Kelola Data Counseling Professional || RUANG BERPROSES</title>
  <!-- Favicon -->
            ...
            <div class="col-lg-6 col-7">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-0 mt-2">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="tampil_data.php">Kelola Data Counseling Professional </a></li>
                </ol>
              </nav>
            </div>
          <!-- Navbar links -->
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header col-lg-6">
              <h3 class="mb-0">TABEL DATA COUNSELING PROFESSIONAL</h3>
          	</div>
            <!-- Light table -->
            ...
            <?php
              include "koneksi.php";     
                //tampilkan data  
               $sql = "SELECT * FROM pendaftaran_counseling_professional";
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="agama">Agama</th>
                    ...
                    <th scope="col" class="sort" data-sort="pendidikan_terakhir">Pendidikan Terakhir</th>
                    <th scope="col" class="sort" data-sort="domisili">Domisili</th>
                    <th scope="col" class="sort" data-sort="kesediaan_mendaftar">kesediaan Mendaftar</th>
          ...
          if ($result->num_rows > 0) {
             ...
             while($row = $result->fetch_assoc()) {
              ...
              <td scope="row"><?= $row["pendidikan_terakhir"]; ?></td>
              <td scope="row"><?= $row["domisili"]; ?></td>
              <td scope="row"><?= $row["kesediaan_mendaftar"]; ?></td>
