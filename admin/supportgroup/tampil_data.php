...
<head>
  ...
  <title>Kelola Data Support Group || RUANG BERPROSES</title>
  <!-- Favicon -->
            ...
            <div class="col-lg-6 col-7">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-0 mt-2">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="tampil_data.php">Kelola Data Support Group </a></li>
                </ol>
              </nav>
            </div>
          <!-- Navbar links -->
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header col-lg-6">
              <h3 class="mb-0">TABEL DATA SUPPORT GROUP</h3>
          	</div>
            <!-- Light table -->
            ...
            <?php
              include "koneksi.php";     
                //tampilkan data  
               $sql = "SELECT * FROM pendaftaran_support_group";
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="pilihan_topik">Pilihan Topik</th>
                    <th scope="col" class="sort" data-sort="pernah_gabung">Pernah Gabung</th>
                    <th scope="col" class="sort" data-sort="pengalaman">Pengalaman</th>
                    <th scope="col" class="sort" data-sort="fasilitator">Fasilitator</th>
                    <th scope="col" class="sort" data-sort="kelompok">Kelompok</th>
                    <th scope="col" class="sort" data-sort="alasan">Alasan</th>
                    <th scope="col" class="sort" data-sort="batasan">Batasan</th>
                    <th scope="col" class="sort" data-sort="harapan">Harapan</th>
                   
                    <th scope="col" class="sort" data-sort="bersedia_gabung">Bersedia Gabung</th>
                    <th scope="col" class="sort" data-sort="setuju_ikut">Setuju Ikut</th>
                    <th scope="col" class="sort" data-sort="setuju_aktif">Setuju Aktif</th>
                    <th scope="col" class="sort" data-sort="konfirmasi_fasilitator">Konfirmasi Fasilitator</th>
                    <th scope="col" class="sort" data-sort="mengikuti_aturan">Mengikuti Aturan</th>
          ...
          if ($result->num_rows > 0) {
             ...
             while($row = $result->fetch_assoc()) {
              ...
              <td scope="row"><?= $row["pilihan_topik"]; ?></td>
				      <td scope="row"><?= $row["pernah_gabung"]; ?></td>
              <td scope="row"><?= $row["pengalaman"]; ?></td>
              <td scope="row"><?= $row["fasilitator"]; ?></td>
              <td scope="row"><?= $row["kelompok"]; ?></td>
              <td scope="row"><?= $row["alasan"]; ?></td>
              <td scope="row"><?= $row["batasan"]; ?></td>
              <td scope="row"><?= $row["harapan"]; ?></td>
              <td scope="row"><?= $row["bersedia_gabung"]; ?></td>
              <td scope="row"><?= $row["setuju_ikut"]; ?></td>
              <td scope="row"><?= $row["setuju_aktif"]; ?></td>
              <td scope="row"><?= $row["konfirmasi_fasilitator"]; ?></td>
              <td scope="row"><?= $row["mengikuti_aturan"]; ?></td>
