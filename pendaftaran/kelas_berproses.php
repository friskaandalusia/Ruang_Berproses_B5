        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Form Pendaftaran Kelas Berproses</h2>
                </div>
                <div class="card-body">
                    <div class="info">
                        <ul>
                            <li>Kelas Berproses 4 <span>"Be Assertive, not Aggressive" </span> bersama Rininta Meyftanoria, M.Psi, Psikolog</li>
                        </ul>
                        <br>
                        ...
                        <p>Event Timing :</p>
                        <ul>
                            <li>Jum'at, 24 September 2021 pukul 19.00-21.00 WIB | Via Zoom Apps</li>
                        </ul>
                        <br />
                        <p>HTM: 25K</p>
                        <br />
                    ...
                    <hr />
                    <div class="form">
                        <form method="POST" action="simpan_kelas_berproses.php" enctype="multipart/form-data">
                            ...
                            <label for="alasan">Alasan Mengikuti Kelas Berproses</label>
                            ...
                            <label for="asal_info">Asal Info Kelas Berproses</label>
                            ...
                            <label for="bukti_pembayaran">Upload bukti pembayaran sesuai dengan webinar yang dipilih untuk <br />
