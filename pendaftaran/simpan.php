...
if( isset($_POST["submit"])) {
    ...
    else
    {
        ...
        if ($file_size < 2048000 and ($file_type =='image/jpeg' or $file_type == 'image/png'))
        {
            ...
            $query = "INSERT INTO pendaftaran_psytalk (nama_lengkap, email, no_telp, usia, pilihan_webinar, domisili, pekerjaan, alasan, pernah_mengikuti, pertanyaan, asal_info, bukti_pembayaran) VALUES('".$nama_lengkap."', '".$email."','".$no_telp."', '".$usia."', '".$pilihan_webinar."', '".$domisili."','".$pekerjaan."','".$alasan."','".$pernah_mengikuti."', '".$pertanyaan."', '".$asal_info."', '".$bukti_pembayaran."')";
