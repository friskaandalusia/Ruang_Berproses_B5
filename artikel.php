                    ...
                    <div class="card-deck  text-lg-left text-center">
                        ...
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="item">
                                    <p> Akhir-akhir ini banyak masyarakat yang mulai aware akan toxic relationship dan dampaknya. Ciri-ciri yang sering dibahas adalah keberadaan gaslighting, kekerasan secara verbal atau fisik, dan lain-lain. Artikel ini akan membahas karakteristik lain yaitu “codependent”.</p>
                                </div>
                                <div id="wrapper">
                    ...
                    <div class="card-deck">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <div id="wrapper">
                                    <a href="artikel4.php" class="btn btn-primary">Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <div id="wrapper">
                                    <a href="artikel5.php" class="btn btn-primary">Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <div id="wrapper">
                                    <a href="artikel6.php" class="btn btn-primary">Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                    </div>
