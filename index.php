...
<head>
	...
	function daftar() {
		if(<?php !isset($_SESSION["login"])?>){
			alert("Login terlebih dahulu sebelum mendaftar");
			a.href = "pengguna/login.php"
		}
					...
					<?php
						if (!isset($_SESSION["login"])) {
							...
							if ($_SESSION["role"] == 1) {
								?>
								<li>
								<a href="admin/dashboard.php" class ="smoothScroll" >Rekap Admin</a>
					...
					<div class="item item-second">
						<div class="caption">
							<div class="col-md-offset-1 col-md-10">
								...
								<h1>PSYTALK</h1>
								<a href="pendaftaran/index.php" class="section-btn btn btn-default btn-blue smoothScroll">Register Now</a>
							</div>
						</div>
					</div>
					...
					<div class="item item-fourth">
						<div class="caption">
							<div class="col-md-offset-1 col-md-10">
								...
								<a href="pendaftaran/peer_counseling.php" class="section-btn btn btn-default btn-blue smoothScroll">Peer Counseling</a>
					...
					<div class="item item-fifth">
						<div class="caption">
							<div class="col-md-offset-1 col-md-10">
								...
								<a href="pendaftaran/support_group.php" class="section-btn btn btn-default btn-gray smoothScroll">Register Now</a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="slide-content slide-display-container">
			<div class="mySlides row" id="layanan_1">
				...
				<div class="col-md-8 col-xs-12 col-sm-6">
					...
					<a class="btn-register" href="pendaftaran/support_group.php" target="_blank">Daftar Sekarang</a>
				</div>
			</div>
			<div class="mySlides row" id="layanan_2">
				...
				<div class="col-md-8 col-xs-12 col-sm-6">
					...
					<a class="btn-register" href="pendaftaran/peer_counseling.php" target="_blank">Daftar Sekarang</a>
			...
			<div class="mySlides row" id="layanan_3">
				...
				<div class="col-md-6 col-sm-4 col-xs-12 poster">
					<div data-wow-delay="0.1s">
						<img src="img/psytalk53.jpg" class="img-responsive" alt="" style="height: 200px; margin: 0 auto;">
					</div>
				</div>
				<div class="col-md-6 col-sm-4 col-xs-12 poster">
					<div data-wow-delay="0.1s">
						<img src="img/psytalk54.jpg" class="img-responsive" alt="" style="height: 200px; margin: 0 auto;">
					</div>
				</div>
				<a class="btn-register" href="pendaftaran/index.php" class="btn btn-info form-control" target="_blank">Daftar Sekarang</a>
			...
			<div class="mySlides row" id="layanan_4">
				...
				<div class="col-md-12 col-sm-4 col-xs-12 poster">
					<div data-wow-delay="0.1s">
						<img src="img/kb4.jpg" class="img-responsive" alt="" style="height: 200px; margin: 0 auto;">
					</div><br>
				</div>
